...
public class BasketRestController {
  ...
  public CompletableFuture<BasketView> getBasket(@PathVariable String basketId) {
  ...
  public Flux<BasketView> updates(@PathVariable String basketId, HttpServletRequest request) {
